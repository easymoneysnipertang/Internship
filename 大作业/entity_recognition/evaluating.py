...
class Metrics(object):
    ...
    def __init__(self, golden_tags, predict_tags, remove_O=False):
        ...
        # 辅助计算的变量
        self.tagset = set(self.golden_tags)  # 将真实标签转化为集合
        self.correct_tags_number = self.count_correct_tags()   # 每种标签被正确预测的个数
        self.predict_tags_counter = Counter(self.predict_tags) # 每种标签在预测标签中出现的个数
        self.golden_tags_counter = Counter(self.golden_tags)   # 每种标签在真实标签中出现的个数
